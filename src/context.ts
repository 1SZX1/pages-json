  ...
  public async writePagesJson(jsons: Record<BuiltInPlatform, PagesJSON.PagesJson>, indent = ' '.repeat(4), eof = '\n'): Promise<boolean> {
    ...
    for (const p2 of p2s) {
      ...
      if (j2subPackages) {
        ...
        for (const j2Sub of j2subPackages) {
          ...
          if (idx > -1) {
            ...
            mergePlatformObject(p1, pagesJson.subPackages[idx], p2, j2sRest, ['pages']);
      ...
      if (j2tabBar) {
        ...
        mergePlatformObject(p1, pagesJson.tabBar, p2, j2tbRest, ['list']);
      ...
      mergePlatformObject(p1, pagesJson, p2, j2rest, ['pages', 'subPackages', 'tabBar']);
    }
